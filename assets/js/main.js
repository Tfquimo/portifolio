...
(function() {
  ...
  // Inicialização dos componentes do Bootstrap, animações e plugins
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Inicialização do Swiper (carrossel de depoimentos)
    if (window.Swiper) {
    ...
    // Inicialização do GLightbox (galeria de imagens)
    if (window.GLightbox) GLightbox({ selector: '.glightbox' });

    // ...outros scripts e inicializações...
  });
